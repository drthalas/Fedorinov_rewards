...
class LegacyShellLightboxTests(unittest.TestCase):
    ...
    def test_static_assets_are_cache_busted(self) -> None:
        ...
        self.assertIn('STATIC_ASSET_VERSION = "20260809-ale364-owner-corrective-1"', templates_py)
    ...
    def test_cascading_guides_preserve_changed_select_value(self) -> None:
        ...
        self.assertIn("data-reward-reference-options", reward_form)
        ...
        self.assertNotIn('data-guide-role="category"', reward_form)
        self.assertNotIn('data-guide-role="subcategory"', reward_form)
