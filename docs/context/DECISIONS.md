...
- В ежедневный отчёт нельзя отправлять внутренние диагностические fallback-фразы. Если автоматический разбор не понял изменение, текст должен оставаться человеческим и должен предлагать сверить журнал разработки.
