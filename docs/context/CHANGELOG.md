...
- Наименования наград в дереве справочника и каскадном фильтре «Сводной таблицы» отсортированы по единому алфавитному правилу.
- Из «Сводной таблицы» удалено только поле «Дополнительно» без изменения остальных фильтров, результатов и пагинации.
- Производная ссылка на Монетный двор в форме награды стала непосредственной кликабельной гиперссылкой без отдельной кнопки.

Release candidate:

- Product scope ограничен ALE-398, ALE-399 и ALE-400 поверх public `v2.0.13`.
- Exact package публикуется только в изолированный Owner candidate channel до merge в `main`.
- Production tag, GitHub Release, `latest.json` и Telegram заблокированы до ручного Owner updater/product PASS и отдельного разрешения.
