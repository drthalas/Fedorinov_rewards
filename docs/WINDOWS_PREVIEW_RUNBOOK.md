...
Постоянный удалённый доступ к выделенному physical Windows gate, его always-on policy и rollback описаны в [Windows Physical Gate Runbook](testing/WINDOWS_PHYSICAL_GATE.md). DHCP-адрес ноутбука не является каноническим адресом доступа.
